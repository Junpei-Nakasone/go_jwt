...
import (
	...
	"github.com/echo-server-tutorial_practice/src/github.com/labstack/echo/middleware"
...
func mainJwt(c echo.Context) error {
	...
	return c.String(http.StatusOK, "you are secret jwt page.")
}
...
func login(c echo.Context) error {
	...
	if username == "jack" && password == "1234" {
		...
		if err != nil {
			...
			return c.String(http.StatusInternalServerError, "went wrong")
		}
...
func createJwtToken() (string, error) {
	// jwt.NewWithClaims関数に渡すclaimsを定義
	claims := JwtClaims{
		"jack",
		jwt.StandardClaims{
			Id:        "main_user_id",
...
func main() {
	...
	// adminGroup.Use(middleware.BasicAuth(func(username, password string, c echo.Context) (error, bool) {
	// 	// check in the DB
	// 	if username == "jack" && password == "1234" {
	// 		return nil, true
	// 	}
